...
//提示界面接口
mock.onGet('/military/prompt').reply(200,[
  {"count":1,"id":1,"keyword":"99坦克","userid":1},
  {"count":1,"id":2,"keyword":"反坦克","userid":1},
  {"count":1,"id":3,"keyword":"反坦克1","userid":1},
  {"count":1,"id":4,"keyword":"反坦克2","userid":1},
  {"count":1,"id":5,"keyword":"反坦克3","userid":1},
  {"count":1,"id":6,"keyword":"40火","userid":1},
]);
//搜索结果接口
mock.onGet('/military/search').reply(1000,{
  "vf": [
  ...
  "atlas": "{\"中文名\":\"军队\",\"部队番号\":\"73011部队\",\"现任军长\":\"蒋谟祥少将\",\"所在战区\":\"东部战区\",\"外文名\":\"PLA 1st Army\",\"部队驻地\":\"浙江湖州\",\"现任政治\":\"委员王平少将\",\"全名\":\"中国人民解放军第1集团军\"}",
  "doc": [
...
//历史搜索接口接口
mock.onGet('/military/history').reply(1000,[
  {"count":1,"id":1,"keyword":"99坦克","userid":1},
  {"count":1,"id":4,"keyword":"反坦克","userid":1}]
);


//相关搜索接口
mock.onGet('military/relationship').reply(1000,{"Keyword":["中国","军队","军事合作","十九大"]});

//历史浏览记录接口

mock.onGet('military/browse').reply(1000,{
    "vf": [
      "{\"summary\":\"99A已经开到天安门前遛弯了，训练场上，官兵们可着劲儿“折腾”老版99。正面射击、侧向射击、倒向射击，在时速20公里以上的行进状态下，车组成员反复锤炼技能、培养默契，以复杂的实战环境为标准，时刻准备着！\",\"duration\":151,\"updateTime\":\"2017-10-23T16:10:05.869\",\"id\":\"AV9S2hTkKyQjnElrV-dy\",\"title\":\"沈阳军区：主战坦克多种射姿秀绝技<span style=\\\\\\\"color:red\\\\\\\">军队</span>\",\"url\":\"http://vv.chinamil.com.cn/asset/category3/2015/09/16/asset_203882.mp4\",\"r_type\":\"vf\"}"
    ],
    "img": [
...
//插入历史浏览记录接口
mock.onGet('military/addBrowse').reply(1000,{
  success:true
});
